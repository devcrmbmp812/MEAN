define(['angular', 'jquery'], function(angular, $) {
  var HomeController = function($scope, $http, $window) {
    if ($window.location.search.indexOf('redirectFrom=voxrec.me') > -1)
      $('#voxrec-eolModal').modal('show');
  };
  ...
  $('#newsletterSignUp').click(function() {
    ...
    if (checkName(nameElement) & checkEmail(emailElement)) {
      ...
      var data = { email: emailElement.val(), name: nameElement.val(), reference: 'voxboneai-page' };
